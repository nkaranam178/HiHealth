...
public class CloudIO {
     ...
     */
    public static void SignUp(final String email, String password, final String first_name, final String last_name, final String location, final Boolean sex, Context context){
